...
export async function POST(request: NextRequest) {
  try {
    ...
    // Send email to admin
    const adminEmail = 'hello@gardenroutedefaults.co.za'; // You can change this to your actual email
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <p style="margin: 8px 0 0 0; opacity: 0.9;">Garden Route Defaults Engine</p>
            </div>
            <div class="content">
              <div class="field">
              ...
              <p style="margin-top: 32px; color: #6b7280; font-size: 14px;">
                This inquiry was submitted through the Garden Route Defaults Engine contact form.
              </p>
            </div>
          </div>
        </body>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Best regards,<br>
              Garden Route Defaults Engine Team</p>
            </div>
          </div>
        </body>
      </html>
    ...
    const [adminResult, userResult] = await Promise.allSettled([
      resend.emails.send({
        from: 'Garden Route Defaults <noreply@gardenroute.com>',
        to: [adminEmail],
      ...
      resend.emails.send({
        from: 'Garden Route Defaults <noreply@gardenroute.com>',
        to: [userEmail],
        subject: 'Thank you for contacting Garden Route Defaults Engine',
        html: userHtml,
      })
    ]);
